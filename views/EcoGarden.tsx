...
import { Sprout, ShoppingBag, ArrowUpCircle, Flower, Trees, Check, Lock, Shovel, Hammer, Maximize } from 'lucide-react';
...
const EcoGarden: React.FC<EcoGardenProps> = ({ user, onUpdateUser }) => {
  ...
  const removePlant = (slotId: number) => {
                            ...
                            return (
                                ...
                                >
                                    {planted ? (
                                        ...
                                        <div className="text-[#a1887f] opacity-50 font-bold text-xs uppercase">
